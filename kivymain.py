...
class LoginApp(MDApp):
    ...
    def build(self):
        ...
        self.strokeData = "https://cis9590-355fe-default-rtdb.firebaseio.com/cis9590-355fe-default-rtdb/Stroke_Data.json"
    ...
    #function to load table and convert it to a pandas dataframe to use for analysis 


    firebase = firebase.FirebaseApplication('https://cis9590-355fe-default-rtdb.firebaseio.com')
    result = firebase.get('cis9590-355fe-default-rtdb/Stroke_Data', None)
    print(result)
